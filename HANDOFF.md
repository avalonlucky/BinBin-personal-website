...
文化墙案例在 07 统筹落地之后新增 08 展厅宣传片，原始文件保存在 `assets/work/culture-wall/showroom-film.mp4`，页面从仓库原始文件地址直接播放，绕开静态托管的单文件体积限制。该视频不得转码、压缩、降分辨率或降码率；源文件与网站资源的 SHA-256 均为 `1feb36cf5dc250d15b34df41d93840b22232137f2920bc9820c9b85ad0e6d6e3`。
