...
- 脱敏用 `redact.py`（局部降采样再放大回原尺寸，不可逆）。若要新增脱敏，
  ...
  不要凭肉眼估算——估算过的坐标基本都偏。
- 人数口径以文件为准：制度列名 **12 人**，企业微信协作群 **17 人**，
  10 月 21 日评审会 **参会 11 人**。早期草稿里的「23 人」是错的，勿沿用。
